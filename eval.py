...
#     print(label_folder_path,prediction_folder_path)
...
#     filenames = os.listdir(prediction_folder_path)
    # iterate the json files in the folder
    # for dirpath, dirnames, filenames in os.listdir(prediction_folder_path):#os.walk(prediction_folder_path):
    ...
    #         amount_files += 1
    #         dirpath = prediction_folder_path
    #             # read json data
    ...
    #         true_positive, false_positive, false_negative = evaluate(prediction_data["points"], label_data["points"], radius=6)
    ...
    # # if true_positive_all_files + false_negative_all_files
...
def check(output_path, label_path):
    ...
    for i in range(len(output_files)):
        prediction_file_path = output_path + output_files[i]
        prediction_file = open(prediction_file_path, "r")
        prediction_data = json.load(prediction_file)

        label_file_path = label_path + label_files[i]
...
output_path = "./output/aicm13/Ch1_001_V/"
label_path = "./label/point_labels/" 
check(output_path, label_path)
